        ...
        >
          <Box className="relative">
            {thumbnailSource ? (
              ...
              <Box
                className={`w-full h-48 bg-gradient-to-br ${fromColor} ${toColor} items-center justify-center`}
              >
...
const Guide = () => {
  ...
  const [videoStates, setVideoStates] = useState<{
    [key: string]: { isPlaying: boolean; showControls: boolean };
  }>({});
  ...
  return (
    <SafeAreaView className="flex-1 bg-blue-50">
      ...
      >
        <Heading
          className="text-blue-700 text-2xl font-medium mb-2 text-left mt-3"
          style={{ fontFamily: "Z06-Walone-Bold" }}
        >
            ...
            {emergencyContacts.map((contact, index) => (
              ...
              >
                <Box className="items-center">
                  ...
                  <Text
                    className="text-gray-800 font-semibold mt-2 text-center"
                    style={{ fontFamily: "Z06-Walone-Bold" }}
                  >
                    {contact.name}
                  </Text>
        ...
        {educationalContent.map((section) => (
          ...
          >
            ...
            >
              <Box className="flex-row items-center">
                <Box
                  className={`w-12 h-12 rounded-full ${section.color} items-center justify-center mr-3 shadow-lg`}
                  style={{
                    shadowColor: "#000",
                ...
                <Box className="bg-green-50 p-3 rounded-xl">
                  {section.guidelines.map((guideline, index) => (
                    <Box key={index} className="flex-row items-start mb-2">
                      ...
                      />
                      <Text
                        className="text-gray-700 ml-2 flex-1"
                        style={{ fontFamily: "Z06-Walone-Bold" }}
                      >
                        {guideline}
                      </Text>
        ...
        <Box className="bg-white rounded-2xl p-4 mb-4 border border-gray-200 shadow-sm">
          ...
          <Box className="flex-row flex-wrap justify-between">
            <Box className="w-[48%] bg-orange-50 p-4 rounded-xl items-center mb-3">
              ...
              <Text
                className="text-gray-800 font-semibold mt-2 text-center text-sm"
                style={{ fontFamily: "Z06-Walone-Bold" }}
              >
                {t("stayInformed")}
              </Text>
